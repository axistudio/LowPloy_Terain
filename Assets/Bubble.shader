...
Shader "Shader Forge/Bubble" {
    Properties {
        ...
        _spaceIntenseity ("spaceIntenseity", Range(0, 10)) = 0
        _reflectionScale ("reflectionScale", Range(-0.5, 0)) = -0.0879527
        _falloffamount ("falloff amount", Range(0, 10)) = 0.6475751
        _EmiitBalue ("EmiitBalue", Range(0, 1)) = 0.6491399
        _node_4207 ("node_4207", 2D) = "white" {}
        _Dissolveamount ("Dissolve amount", Range(0, 1)) = 0
        _FresnelIntenseity ("FresnelIntenseity", Range(1, 5)) = 1.616589
        _FresebekColor ("FresebekColor", Color) = (1,0,0,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _FresnelIntenseity;
            uniform float4 _FresebekColor;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 node_6923 = (node_8692*(pow(1.0-max(0,dot(normalDirection, viewDirection)),_falloffamount)*_FresnelIntenseity)*_FresebekColor.rgb);
